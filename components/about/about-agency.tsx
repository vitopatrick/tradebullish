        ...
        <div className=" col-span-2">
          ...
          <div className="w-full">
            ...
            <p className="font-body font-light text-[0.9rem]">
              ...
              experience in the Cryptocurrency industry, we understand the
              challenges and opportunities that brokers face and are committed
              to providing the highest quality service and support
            </p>
          </div>
        </div>
      </div>
